...
ray job submit --address="http://127.0.0.1:8265" \
  ...
  --remote_rm_url /fs/nexus-scratch/zli12321/active-topic-modeling/deepresearch/openrlhf_rl/reward_functions_no_cot/pedants/pedants_reward.py \
  --save_path /fs/clip-scratch/lizongxia/grpo_weights/el5/Qwen-1.5B-no-cot/pedants \
