...
# def random_uniform():
#     """Return a random float uniformly distributed between 0 and 1."""
#     return random.random()

def reward_func(queries, prompts, labels, save_path="../../completions/el5/1.5B-no-cot-mixed/el5-random.jsonl"):
    """
    For each example:
